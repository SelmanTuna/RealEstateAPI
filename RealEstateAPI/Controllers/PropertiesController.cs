...
namespace RealEstateAPI.Controllers
{
    ...
    public class PropertiesController : ControllerBase
    {
        ...
        //public IActionResult Post([FromBody] Property poperty)
        //{
        //    //Get email claims from the json web token 
        //    //Add the poperty record
        //    // Save the changes
        //}
        ...
        {
            var propertiesResult=_dbContext.Properties.FirstOrDefault(p => p.Address.Contains(address));
            if (propertiesResult == null)
            {
                return NotFound();
            }
